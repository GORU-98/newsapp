...
console.log(this.state.totalResults)
    ...
    let url=`https://newsapi.org/v2/everything?q=apple&from=2022-12-28&to=2022-12-28&sortBy=popularity&apiKey=647739fe51424fc3bbf83735e1977033&page=${this.state.page + 1}&pageSize=${this.props.pageSize}`
    this.setState({
        loading:true
    })
    let data= await fetch(url);
